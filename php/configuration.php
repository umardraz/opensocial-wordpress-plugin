...
require_once (dirname(__FILE__) . "/extlib/xmlseclibs/xmlseclibs.php");
	...
	function onelogin_saml_configuration() {
		...
		add_settings_field('onelogin_saml_advanced_digestalgorithm', __('Digest Algorithm', 'onelogin-saml-sso'), "plugin_setting_select_onelogin_saml_advanced_digestalgorithm", $option_group, 'advanced_settings');
                ...
                add_settings_section('site_access', __('Site Access', 'onelogin-saml-sso'), 'plugin_section_site_access_text', $option_group);
		register_setting($option_group, 'opensocial_site_access');
		add_settings_field('opensocial_site_access', '', "plugin_setting_string_opensocial_site_access", $option_group, 'site_access');                
	...
	function plugin_setting_select_onelogin_saml_advanced_digestalgorithm() {
        ...
        // site access
        function plugin_setting_string_opensocial_site_access() {
            $value = get_option('opensocial_site_access')? get_option('opensocial_site_access') : 'open';
           
            echo '<label><input name="opensocial_site_access" type="radio" value="open" ' . checked($value,"open",false) . ' /> ';
            esc_html_e('Open','onelogin-saml-sso');
            echo '</label>';
            echo '<br />';   
            echo '<label><input name="opensocial_site_access" type="radio" value="private" ' . checked($value,"private",false). ' /> ';
            esc_html_e("Private",'onelogin-saml-sso');
            echo '</label>'; 
            echo '<br />';
            echo '<label><input name="opensocial_site_access" type="radio" value="closed" ' . checked($value,"closed",false). ' /> ';
            esc_html_e("Closed",'onelogin-saml-sso');
            echo '</label>';             
            
        }//plugin_setting_string_opensocial_site_access
	...
	function plugin_section_advanced_settings_text() {
        ...
        function plugin_section_site_access_text() {
            echo "<p>";
            _e( 'Select site access level.', 'my-text-domain' );
            echo "</p>";
        }
